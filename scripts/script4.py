...
<head>
    ...
    <link rel="icon" href="https://cdn.gh-proxy.org/https://github.com/fanghuangxu/62/raw/refs/heads/main/icons/icon/fe43525e778ed14a76bd691e3cd8c807.png" type="image/png">
</head>

<body>
    <div class="student-profile" style="width: 500px; height: 600px;">
    <h1>{name}</h1>
    <img src="https://cdn.gh-proxy.org/https://github.com/fanghuangxu/62/raw/refs/heads/main/icons/students/{number}.jpg" alt="head image" style="width: 200px; height: 200px; object-fit: cover;">
    <p>名字: {name}</p>
    <p>座号: {number}</p>
    <div class="contact">
        <p>微信: {wechat}</p>
